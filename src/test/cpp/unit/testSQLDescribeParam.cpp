...
TEST(SQLDescribeParam, DescribeParameter) {
  DECLARE_SQLHANDLES
  ...
  retcode = SQLExecDirect(hstmt,
      (SQLCHAR*)"CREATE TABLE SQLDESCRIBEPARAM (ID INTEGER, "
          "NAME CHAR(80), AGE SMALLINT)", SQL_NTS);
  ...
  retcode = SQLPrepare(hstmt,
      (SQLCHAR*)"INSERT INTO SQLDESCRIBEPARAM VALUES (?, ?, ?)", SQL_NTS);
  ...
  SQL_SMALLINT, 0, 0, &typ_smallint, 0, &cbSmallint);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLBindParameter");
  ...
  /* --- Drop Table ----------------------------------------------- */
  retcode = SQLExecDirect(hstmt, (SQLCHAR*)"DROP TABLE SQLDESCRIBEPARAM",
      SQL_NTS);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLExecDirect");
