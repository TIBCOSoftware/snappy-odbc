...
TEST(SQLColAttribute, ColumnAttributes) {
  DECLARE_SQLHANDLES
  ...
  retcode = SQLColAttribute(hstmt, icol, fDescType, (PTR)&rgbDesc, cbDescMax,
      &pcbDesc, &pfDesc);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLColAttribute 1.");
  ...
  LOGF("3.SQL_COLUMN_COUNT: '%ld'", pfDesc);
  ...
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLColAttribute 4.");
  LOGF("4.SQL_COLUMN_DISPLAY_SIZE: '%ld'", pfDesc);
  ...
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLColAttribute 6.");
  LOGF("6.SQL_COLUMN_LENGTH: '%ld'", pfDesc);
  ...
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLColAttribute 11.");
  LOGF("11.SQL_COLUMN_PRECISION: '%ld'", pfDesc);
  ...
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLColAttribute 12.");
  LOGF("12.SQL_COLUMN_QUALIFIER_NAME (ODBC 2.0): '%s'", rgbDescChar);
  ...
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLColAttribute 13.");
  LOGF("13.SQL_COLUMN_SCALE: '%ld'", pfDesc);
  ...
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLColAttribute 16.");
  LOGF("16.SQL_COLUMN_TYPE: '%ld'", pfDesc);
