...
TEST(SQLSetStmtAttr, CheckSetAttrs) {
  DECLARE_SQLHANDLES
  ...
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_APP_PARAM_DESC,
      (SQLPOINTER)&strLengthPtr, strLengthPtr);
#if defined(TEST_DIRECT) || defined(_WINDOWS)
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_ERROR, retcode,
      "SQLSetStmtAttr");
#else
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_INVALID_HANDLE, retcode,
      "SQLSetStmtAttr");
#endif

  /* *** 2. SQL_ATTR_APP_ROW_DESC */
  LOGF("SQLSetStmtAttr ->2. SQL_ATTR_APP_ROW_DESC : "
  ...
  LOGF("SQLSetStmtAttr ->3. SQL_ATTR_ASYNC_ENABLE : "
      "Value = 'SQL_ASYNC_ENABLE_ON'");
  ...
  LOGF("SQLSetStmtAttr ->4. SQL_ATTR_CONCURRENCY : "
      "Value = 'SQL_CONCUR_READ_ONLY'");
  ...
  LOGF("SQLSetStmtAttr ->5. SQL_ATTR_CURSOR_SCROLLABLE : "
      "Value = 'SQL_NONSCROLLABLE'");
  ...
  LOGF("SQLSetStmtAttr ->6. SQL_ATTR_CURSOR_SENSITIVITY : "
      "Value = 'SQL_INSENSITIVE'");
  ...
  LOGF("SQLSetStmtAttr ->7. SQL_ATTR_CURSOR_TYPE : "
  ...
  LOGF("SQLSetStmtAttr ->8. SQL_ATTR_ENABLE_AUTO_IPD : "
      "Value = 'SQL_TRUE'");
  ...
  LOGF("SQLSetStmtAttr ->9. SQL_ATTR_FETCH_BOOKMARK_PTR : "
      "Value = '%s'", buffer);
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_FETCH_BOOKMARK_PTR,
      (SQLPOINTER)nullptr, strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");

  /* *** 10. SQL_ATTR_IMP_PARAM_DESC (ODBC 3.0) */
  LOGF("SQLSetStmtAttr ->10. SQL_ATTR_IMP_PARAM_DESC : "
      "Value = 'NULL'");
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_IMP_PARAM_DESC, (SQLPOINTER)nullptr,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_ERROR, retcode,
      "SQLSetStmtAttr");
  ...
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_IMP_ROW_DESC, (SQLPOINTER)nullptr,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_ERROR, retcode,
      "SQLSetStmtAttr");

  /* *** 12. SQL_ATTR_KEYSET_SIZE (ODBC 2.0) */
  LOGF("SQLSetStmtAttr ->12. SQL_ATTR_KEYSET_SIZE : Value = '%d'", 100);
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_KEYSET_SIZE, (SQLPOINTER)100,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");

  /* *** 13. SQL_ATTR_MAX_LENGTH */
  LOGF("SQLSetStmtAttr ->13. SQL_ATTR_MAX_LENGTH : Value = '%d'", 1024);
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_MAX_LENGTH, (SQLPOINTER)1024,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");
  ...
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_MAX_ROWS, (SQLPOINTER)1000,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");

  /* *** 15. SQL_ATTR_METADATA_ID (ODBC 3.0) */
  LOGF("SQLSetStmtAttr ->15. SQL_ATTR_METADATA_ID : Value = 'SQL_TRUE'");
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_METADATA_ID, (SQLPOINTER)SQL_TRUE,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");

  LOGF("SQLSetStmtAttr ->15. SQL_ATTR_METADATA_ID : Value = 'SQL_FALSE'");
  ...
  /* *** 16. SQL_ATTR_NOSCAN */
  LOGF("SQLSetStmtAttr ->16. SQL_ATTR_NOSCAN : Value = SQL_NOSCAN_OFF");
  ...
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_NOSCAN, (SQLPOINTER)SQL_NOSCAN_ON,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");
  ...
  LOGF("SQLSetStmtAttr ->18. SQL_ATTR_PARAM_BIND_TYPE : "
      "Value = 'SQL_PARAM_BIND_BY_COLUMN'");
  ...
  LOGF("SQLSetStmtAttr ->19. SQL_ATTR_PARAM_OPERATION_PTR : Value = 'NULL'");
  ...
  LOGF("SQLSetStmtAttr ->20. SQL_ATTR_PARAM_STATUS_PTR : Value = '%s'",
      buffer);
  ...
  LOGF("SQLSetStmtAttr ->21. SQL_ATTR_PARAMS_PROCESSED_PTR : Value = '%s'",
      buffer);
  ...
  LOGF("SQLSetStmtAttr ->22. SQL_ATTR_PARAMSET_SIZE : Value = '%d'", 1000);
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_PARAMSET_SIZE, (SQLPOINTER)1000,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");

  /* *** 23. SQL_ATTR_QUERY_TIMEOUT */
  LOGF("SQLSetStmtAttr ->23. SQL_ATTR_QUERY_TIMEOUT : Value = '%d'", 100);
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_QUERY_TIMEOUT, (SQLPOINTER)100,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");

  /* *** 24. SQL_ATTR_RETRIEVE_DATA (ODBC 2.0) */
  LOGF("SQLSetStmtAttr ->24. SQL_ATTR_RETRIEVE_DATA : Value = 'SQL_RD_OFF'");
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_RETRIEVE_DATA,
      (SQLPOINTER)SQL_RD_OFF, strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_ERROR, retcode,
      "SQLSetStmtAttr");

  LOGF("SQLSetStmtAttr ->24. SQL_ATTR_RETRIEVE_DATA : Value = 'SQL_RD_ON'");
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_RETRIEVE_DATA,
  ...
  LOGF("SQLSetStmtAttr ->25. SQL_ATTR_ROW_ARRAY_SIZE : Value = '%d'", 1024);
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_ROW_ARRAY_SIZE, (SQLPOINTER)1024,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");

  /* *** 26. SQL_ATTR_ROW_BIND_OFFSET_PTR (ODBC 3.0) */
  LOGF("SQLSetStmtAttr ->26. SQL_ATTR_ROW_BIND_OFFSET_PTR : "
      "Value = '%s'", buffer);
  ...
  LOGF("SQLSetStmtAttr ->27. SQL_ATTR_ROW_BIND_TYPE : "
      "Value = 'SQL_BIND_BY_COLUMN'");
  ...
  LOGF("SQLSetStmtAttr ->29. SQL_ATTR_ROW_OPERATION_PTR : Value = '%s'",
      buffer);
  ...
  LOGF("SQLSetStmtAttr ->30. SQL_ATTR_ROW_STATUS_PTR : Value = '%s'",
      buffer);
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_ROW_STATUS_PTR, (SQLPOINTER)nullptr,
      strLengthPtr);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");
  ...
  LOGF("SQLSetStmtAttr ->30. SQL_ATTR_ROWS_FETCHED_PTR : Value = '%s'",
      buffer);
  ...
  LOGF("SQLSetStmtAttr ->32. SQL_ATTR_SIMULATE_CURSOR : "
  ...
  LOGF("SQLSetStmtAttr ->33. SQL_ATTR_USE_BOOKMARKS : "
      "Value = 'SQL_UB_OFF'");
...
// TODO: no support for procedures in SnappyData Spark
TEST(SQLSetStmtAttr, DISABLED_QueryTimeout) {
  DECLARE_SQLHANDLES
  ...
  /* --- Create Table --------------------------------------------- */
  LOGF("Create Stmt = 'CREATE TABLE SQLQUERYTIMEOUT(ID INTEGER, "
      "NAME VARCHAR(80), AGE SMALLINT)'");
  retcode = SQLExecDirect(hstmt,
      (SQLCHAR*)"CREATE TABLE SQLQUERYTIMEOUT(ID INTEGER, "
  ...
  retcode = SQLExecDirect(hstmt,
      (SQLCHAR*)"CREATE PROCEDURE PROC_ADD_QUERY_OBSRVR("
          "sleepTime int) LANGUAGE JAVA PARAMETER STYLE JAVA "
          "EXTERNAL NAME 'tests.TestProcedures.addQueryObserver'", SQL_NTS);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLExecDirect");

  LOG("\tCreate stored proedure Stmt='CREATE PROCEDURE "
      "PROC_REMOVE_QUERY_OBSRVR() LANGUAGE JAVA PARAMETER STYLE JAVA "
      "EXTERNAL NAME 'tests.TestProcedures.removeQueryObserver''");
  retcode = SQLExecDirect(hstmt,
  ...
  retcode = SQLSetStmtAttr(hstmt, SQL_ATTR_QUERY_TIMEOUT, (SQLPOINTER)1, 0);
  DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
      "SQLSetStmtAttr");
