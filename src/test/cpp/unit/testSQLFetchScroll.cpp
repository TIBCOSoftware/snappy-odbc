...
TEST(SQLFetchScroll, FetchScroll) {
  DECLARE_SQLHANDLES
  ...
  if (retcode == SQL_SUCCESS) {
    ...
    while (1) {
      ...
      if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO) {
        DoPrintArray((CHAR*)"SQL_FETCH_NEXT", 1, sNumber_rc, szString_rc);
      } else {
        break;
      }
    }
    ...
    if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO) {
      DoPrintArray((CHAR*)"SQL_FETCH_FIRST", 1, sNumber_rc, szString_rc);
    }
    /* ***** SQL_FETCH_PRIOR *** ---------------------------------------- */
    retcode = SQLFetchScroll(hstmt, SQL_FETCH_NEXT, 1);
    DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_SUCCESS, retcode,
    ...
    if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO) {
      DoPrintArray((CHAR*)"SQL_FETCH_PRIOR", 1, sNumber_rc, szString_rc);
    }
    /* ***** SQL_FETCH_LAST  *** ---------------------------------------- */
    ...
    if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO) {
      DoPrintArray((CHAR*)"SQL_FETCH_LAST", 1, sNumber_rc, szString_rc);
    }
    /* ***** SQL_FETCH_ABSOLUTE *** ------------------------------------- */
    ...
    if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO) {
      DoPrintArray((CHAR*)"SQL_FETCH_ABSOLUTE", 1, sNumber_rc, szString_rc);
    }
    /* ***** SQL_FETCH_RELATIVE *** ------------------------------------- */
    ...
    if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO) {
      DoPrintArray((CHAR*)"SQL_FETCH_RELATIVE", 1, sNumber_rc, szString_rc);
    }
  }
