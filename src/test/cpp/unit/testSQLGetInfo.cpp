 ...
 *
 Info Type                               Values
 ==============================================================
 SQL_DRIVER_NAME                         "libsnappyodbc.so" or "snappyodbc.dll"
 SQL_DRIVER_VER                          "01.03.0000"
 SQL_DBMS_NAME                           "SnappyData"
 SQL_DBMS_VER                            "01.06.0600"
...
void PutDriverInformation(SQLHENV henv, SQLHDBC hdbc, SQLHSTMT hstmt) {
  ...
  SQLPOINTER rgbInfoValueHandle;

  rgbInfoValueChar[0] = 0;
  rgbInfoValue = 0;
  rgbInfoValueHandle = 0;
  ...
  retcode = SQLGetInfo(hdbc, SQL_ACTIVE_STATEMENTS, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 1.2");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DATA_SOURCE_NAME, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 1.3");
  LOGF("Value = '%s'", rgbInfoValueChar);

  /* *** 4. SQL_DRIVER_HDBC !*/
  LOGF("1.4.SQL_DRIVER_HDBC : ");
  // below is implemented only in driver manager
  retcode = SQLGetInfo(hdbc, SQL_DRIVER_HDBC, &rgbInfoValueHandle, 0, nullptr);
#ifdef TEST_DIRECT
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_ERROR, retcode, "SQLGetInfo 1.4");
#else
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 1.4");
#endif
  LOGF("Value = '%p'", rgbInfoValueHandle);

  /* *** 5. SQL_DRIVER_HENV !*/
  LOGF("1.5.SQL_DRIVER_HENV : ");
  // below is implemented only in driver manager
  retcode = SQLGetInfo(hdbc, SQL_DRIVER_HENV, &rgbInfoValueHandle, 0, nullptr);
#ifdef TEST_DIRECT
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_ERROR, retcode, "SQLGetInfo 1.5");
#else
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 1.5");
#endif
  LOGF("Value = '%p'", rgbInfoValueHandle);

  /* *** 6. SQL_DRIVER_HLIB       (ODBC 2.0) !*/
  LOGF("1.6.SQL_DRIVER_HLIB (ODBC 2.0) : ");
  // implemented only by DriverManager
  retcode = SQLGetInfo(hdbc, SQL_DRIVER_HLIB, &rgbInfoValueHandle, 0, nullptr);
#ifdef TEST_DIRECT
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_ERROR, retcode, "SQLGetInfo 1.6");
#else
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 1.6");
#endif
  LOGF("Value = '%p'", rgbInfoValueHandle);

  /* *** 7. SQL_DRIVER_HSTMT ! */
  LOGF("1.7.SQL_DRIVER_HSTMT : ");
  retcode = SQLGetInfo(hdbc, SQL_DRIVER_HSTMT, &rgbInfoValueHandle, 0, nullptr);
  ...
  retcode = SQLGetInfo(hdbc, SQL_FILE_USAGE, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 1.12");
  /* switch (rgbInfoValue) {
  ...
  /* LOGF("1.16.SQL_ODBC_SAG_CLI_CONFORMANCE : ");
   ...
   (PTR) & rgbInfoValue, sizeof(rgbInfoValue), nullptr);
   DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
   "SQLGetInfo 1.16");
   switch (rgbInfoValue) {
  ...
  retcode = SQLGetInfo(hdbc, SQL_ROW_UPDATES, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 1.19");
  LOGF("Value = '%s'", rgbInfoValueChar);

  /* *** 20.SQL_SEARCH_PATTERN_ESCAPE !*/
  LOGF("1.20.SQL_SEARCH_PATTERN_ESCAPE : ");
  retcode = SQLGetInfo(hdbc, SQL_SEARCH_PATTERN_ESCAPE,
      (PTR)&rgbInfoValueChar, sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 1.20");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_SERVER_NAME, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 1.21");
  LOGF("Value = '%s'", rgbInfoValueChar);
}
...
void PutDBMSProductInformation(SQLHENV henv, SQLHDBC hdbc, SQLHSTMT hstmt) {
  ...
  retcode = SQLGetInfo(hdbc, SQL_DATABASE_NAME, rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo 2.1");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_DBMS_NAME, rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo 2.2");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_DBMS_VER, rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo 2.3");
  LOGF("Value = '%s'", rgbInfoValueChar);
...
void PutDataSourceInformation(SQLHENV henv, SQLHDBC hdbc, SQLHSTMT hstmt) {
  ...
  retcode = SQLGetInfo(hdbc, SQL_ACCESSIBLE_PROCEDURES,
      (PTR)rgbInfoValueChar, sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.1");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_ACCESSIBLE_TABLES, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.2");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_BOOKMARK_PERSISTENCE, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.3");
  strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_CONCAT_NULL_BEHAVIOR, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.4");
  switch (rgbInfoValue) {
    case SQL_CB_NULL:
  ...
  LOGF("Value = '%s'", buffer);
  ASSERT_EQ(rgbInfoValue, SQL_CB_NULL);
  ...
  retcode = SQLGetInfo(hdbc, SQL_CURSOR_ROLLBACK_BEHAVIOR, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo 3.6");
  switch (rgbInfoValue) {
  ...
  retcode = SQLGetInfo(hdbc, SQL_DATA_SOURCE_READ_ONLY,
      (PTR)rgbInfoValueChar, sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.7");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_DEFAULT_TXN_ISOLATION, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.8");
  strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_MULT_RESULT_SETS, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.9");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_MULTIPLE_ACTIVE_TXN, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.10");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_NEED_LONG_DATA_LEN, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.11");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_NULL_COLLATION, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.12");
  switch (rgbInfoValue) {
    case SQL_NC_END:
  ...
  retcode = SQLGetInfo(hdbc, SQL_OWNER_TERM, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.13");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_PROCEDURE_TERM, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.14");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_QUALIFIER_TERM, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.15");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_SCROLL_CONCURRENCY, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.16");
  strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_STATIC_SENSITIVITY, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.18");
  strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_TABLE_TERM, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.19");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_TXN_CAPABLE, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.20");
  switch (rgbInfoValue) {
    case SQL_TC_NONE:
  ...
  retcode = SQLGetInfo(hdbc, SQL_TXN_ISOLATION_OPTION, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.21");
  strcpy(buffer, " ");
  if (rgbInfoValue & SQL_TXN_READ_UNCOMMITTED) strcat(buffer,
      "SQL_TXN_READ_UNCOMMITTED |");
  if (rgbInfoValue & SQL_TXN_READ_COMMITTED) strcat(buffer,
  ...
  retcode = SQLGetInfo(hdbc, SQL_USER_NAME, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 3.22");
  LOGF("Value = '%s'", rgbInfoValueChar);
#endif
}
/*
...
void PutSupportedSQL(SQLHENV henv, SQLHDBC hdbc, SQLHSTMT hstmt) {
  ...
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo 4.8");
  sprintf(buffer, "\tValue = %s", rgbInfoValueChar);
  LOG(buffer);
...
/*
 ...
 -------------------------------------------------------------------------
 */
void PutScalarFunctionInformation(SQLHENV henv, SQLHDBC hdbc,
    SQLHSTMT hstmt) {
...
void PutODBC30Information(SQLHENV henv, SQLHDBC hdbc, SQLHSTMT hstmt) {
  ...
  retcode = SQLGetInfo(hdbc, SQL_ACTIVE_ENVIRONMENTS, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.1");
  LOGF("Value = '%d'", rgbInfoValue);
  ...
  retcode = SQLGetInfo(hdbc, SQL_AGGREGATE_FUNCTIONS, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.2");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_ALTER_DOMAIN, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.3");
  /* strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_ASYNC_MODE, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.4");
  /* switch (rgbInfoValue) {
   ...
   break;
   default:
   ADD_FAILURE() << "Unknown value for SQL_ASYNC_MODE: " << rgbInfoValue;
   break;
   }
   LOGF("Value = '%s'", buffer);*/
  ...
  switch (rgbInfoValue) {
    ...
    case SQL_BRC_EXPLICIT:
      ...
      break;
    default:
      ADD_FAILURE() << "Unknown value for SQL_BATCH_ROW_COUNT: "
          << rgbInfoValue;
      break;
  }
  LOGF("Value = '%s'", buffer);
  ...
  /* switch (rgbInfoValue) {
   ...
   break;
   default:
   ADD_FAILURE() << "Unknown value for SQL_BATCH_SUPPORT: " << rgbInfoValue;
   break;
   }
   LOGF("Value = '%s'", buffer);*/
  ...
  retcode = SQLGetInfo(hdbc, SQL_CATALOG_NAME, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.7");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_COLLATION_SEQ, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.8");
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_CREATE_ASSERTION, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.9");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DROP_ASSERTION, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.10");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_CREATE_CHARACTER_SET, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.11");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DROP_CHARACTER_SET, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.12");
  /* strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_CREATE_COLLATION, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.13");
  /* strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DROP_COLLATION, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.14");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_CREATE_DOMAIN, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.15");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DROP_DOMAIN, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.16");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_CREATE_SCHEMA, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.17");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DROP_SCHEMA, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.18");
  /* strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_CREATE_TABLE, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.19");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DROP_TABLE, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.20");
  /* strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_CREATE_TRANSLATION, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.21");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DROP_TRANSLATION, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.22");
  /* strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_CREATE_VIEW, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.23");
  /* strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DROP_VIEW, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.24");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_CURSOR_SENSITIVITY, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.25");
  /*switch (rgbInfoValue) {
   ...
   break;
   default:
   ADD_FAILURE() << "Unknown value for SQL_CURSOR_SENSITIVITY: "
   << rgbInfoValue;
   break;
   }
   LOGF("Value = '%s'", buffer);*/
  ...
  retcode = SQLGetInfo(hdbc, SQL_DATETIME_LITERALS, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.26");
  /* strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_DDL_INDEX, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.27");
  /*switch (rgbInfoValue) {
   ...
   break;
   default:
   ADD_FAILURE() << "Unknown value for SQL_DDL_INDEX: " << rgbInfoValue;
   break;
   }
   LOGF("Value = '%s'", buffer);*/
  ...
  retcode = SQLGetInfo(hdbc, SQL_DESCRIBE_PARAMETER, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.28");
  // LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  retcode = SQLGetInfo(hdbc, SQL_DM_VER, (PTR)rgbInfoValueChar,
      sizeof(rgbInfoValueChar), nullptr);
#ifdef TEST_DIRECT
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_ERROR, retcode, "SQLGetInfo 8.29");
#else
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.29");
#endif
  LOGF("Value = '%s'", rgbInfoValueChar);
  ...
  /*LOGF("8.30.SQL_DRIVER_HDESC : ");
   ...
   #ifdef _WINDOWS
   retcode = SQLGetStmtAttr(hstmt,SQL_ATTR_APP_PARAM_DESC, &hdesc, SQL_IS_INTEGER, nullptr);
   DIAGRECCHECK(SQL_HANDLE_STMT, hstmt, 1, SQL_ERROR, retcode,"SQLGetStmtAttr");
   #endif
   retcode = SQLGetInfo(hdbc, SQL_DRIVER_HDESC, &rgbInfoValueHandle,
       cbInfoValueMax, nullptr);
  ...
  retcode = SQLGetInfo(hdbc, SQL_INDEX_KEYWORDS, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.31");
  /* strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_INFO_SCHEMA_VIEWS, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.32");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_INSERT_STATEMENT, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.33");
  /*strcpy(buffer, " ");
  ...
  retcode = SQLGetInfo(hdbc, SQL_MAX_ASYNC_CONCURRENT_STATEMENTS,
      (PTR)&rgbInfoValue, sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.34");
  //LOGF("Value = '%d'", rgbInfoValue);
  ...
  switch (rgbInfoValue) {
    ...
    case SQL_OIC_LEVEL2:
      ...
      break;
    default:
      ADD_FAILURE() << "Unknown value for SQL_ODBC_INTERFACE_CONFORMANCE: "
          << rgbInfoValue;
      break;
  }
  LOGF("Value = '%s'", buffer);
  ...
  switch (rgbInfoValue) {
    ...
    case SQL_PARC_NO_BATCH:
      ...
      break;
    default:
      ADD_FAILURE() << "Unknown value for SQL_PARAM_ARRAY_ROW_COUNTS: "
          << rgbInfoValue;
      break;
  }
  LOGF("Value = '%s'", buffer);
  ...
  retcode = SQLGetInfo(hdbc, SQL_PARAM_ARRAY_SELECTS, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode, "SQLGetInfo 8.39");
  /* switch (rgbInfoValue) {
   case SQL_PAS_BATCH:
   ...
   break;
   default:
   ADD_FAILURE() << "Unknown value for SQL_PARAM_ARRAY_SELECTS: "
   << rgbInfoValue;
   break;
   }
   LOGF("Value = '%s'", buffer);*/
  ...
  switch (rgbInfoValue) {
    ...
    case SQL_SC_SQL92_INTERMEDIATE:
      ...
      break;
    default:
      ADD_FAILURE() << "Unknown value for SQL_SQL_CONFORMANCE: "
          << rgbInfoValue;
      break;
  }
  LOGF("Value = '%s'", buffer);
  ...
  retcode = SQLGetInfo(hdbc, SQL_STANDARD_CLI_CONFORMANCE, (PTR)&rgbInfoValue,
      sizeof(rgbInfoValue), nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo 8.41");
  strcpy(buffer, " ");
...
TEST(SQLGetInfo, TestRequired) {
  ...
  retcode = ::SQLGetInfo(SQL_NULL_HANDLE, 0, nullptr, 0, nullptr);
  EXPECT_EQ(SQL_INVALID_HANDLE, retcode)
      << "SQLGetInfo returned invalid handle";
  retcode = ::SQLGetInfo(hdbc, 999, nullptr, 0, nullptr);
  EXPECT_EQ(SQL_ERROR, retcode) << "SQLGetInfo should return sql error";

  SQLCHAR infoBuffer[1024];
  SQLWCHAR infoBufferW[1024];

  retcode = ::SQLGetInfo(hdbc, SQL_DRIVER_NAME, infoBuffer, 1024, nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo (HDBC)");
#ifdef _WINDOWS
  EXPECT_EQ(std::string("snappyodbc.dll"), std::string(
      (char*)infoBuffer)) << "SQLGetInfo should return driver name";
#elif defined (_MACOSX)
  EXPECT_EQ(std::string("libsnappyodbc.dylib"), std::string(
      (char*)infoBuffer)) << "SQLGetInfo should return driver name";
#else
  EXPECT_EQ(std::string("libsnappyodbc.so"), std::string(
      (char*)infoBuffer)) << "SQLGetInfo should return driver name";
#endif

  retcode = ::SQLGetInfo(hdbc, SQL_DRIVER_VER, infoBuffer, 1024, nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo (HDBC)");
  EXPECT_EQ(std::string("01.03.0000"), std::string((char*)infoBuffer))
      << "SQLGetInfo should return driver version 01.03.0000";

  retcode = ::SQLGetInfo(hdbc, SQL_DRIVER_ODBC_VER, infoBuffer, 1024,
      nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo (HDBC)");
  EXPECT_EQ(std::string("03.52"), std::string((char*)infoBuffer))
      << "SQLGetInfo should return odbc driver version 03.52";

  retcode = ::SQLGetInfo(hdbc, SQL_ODBC_VER, infoBuffer, 1024, nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo (HDBC)");
#ifdef TEST_DIRECT
  EXPECT_EQ(std::string("03.52.0000"), std::string((char*)infoBuffer))
      << "SQLGetInfo should return odbc version 03.52.0000";
#elif defined(_WINDOWS)
  EXPECT_EQ(std::string("03.80.0000"), std::string((char*)infoBuffer))
    << "SQLGetInfo should return odbc version 03.80.0000";
#else
  EXPECT_EQ(std::string("03.52"), std::string((char*)infoBuffer))
      << "SQLGetInfo should return odbc version 03.52";
#endif

  retcode = ::SQLGetInfoW(hdbc, SQL_PRODUCT_NAME, infoBufferW, 1024, nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfoW (HDBC)");
  std::string asciiResult;
  SQLWCHAR* pbuffer = infoBufferW;
  SQLWCHAR wch;
  while ((wch = *pbuffer++) != 0) {
    asciiResult.push_back((char)wch);
  }
  EXPECT_EQ(std::string("SnappyData"), asciiResult)
      << "SQLGetInfo should return driver name for custom SQL_PRODUCT_NAME";

  retcode = ::SQLGetInfo(hdbc, SQL_DBMS_NAME, infoBuffer, 1024, nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo (HDBC)");
  EXPECT_EQ(std::string("SnappyData"),
      std::string((char*)infoBuffer)) << "SQLGetInfo should return DBMS";

  retcode = ::SQLGetInfo(hdbc, SQL_DBMS_VER, infoBuffer, 1024, nullptr);
  DIAGRECCHECK(SQL_HANDLE_DBC, hdbc, 1, SQL_SUCCESS, retcode,
      "SQLGetInfo (HDBC)");
  EXPECT_EQ(std::string("01.06.0600"),
      std::string((char*)infoBuffer)) << "SQLGetInfo should return DB version";

  retcode = ::SQLGetInfo(hdbc, SQL_EXPRESSIONS_IN_ORDERBY, infoBuffer, 1024,
      nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ(std::string("Y"), std::string((char*)infoBuffer))
      << "SQLGetInfo should return Y";
  SQLUINTEGER infoVal = 0;
  retcode = ::SQLGetInfo(hdbc, SQL_SCROLL_OPTIONS, &infoVal, 0, nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ(17U, infoVal) << "SQLGetInfo returned successfully";

  retcode = ::SQLGetInfo(hdbc, SQL_DYNAMIC_CURSOR_ATTRIBUTES1, &infoVal, 0,
      nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ((SQL_CA1_POS_POSITION | SQL_CA1_POS_UPDATE | SQL_CA1_POS_DELETE
      | SQL_CA1_POS_REFRESH | SQL_CA1_LOCK_NO_CHANGE | SQL_CA1_POSITIONED_UPDATE
      | SQL_CA1_POSITIONED_DELETE | SQL_CA1_SELECT_FOR_UPDATE | SQL_CA1_BULK_ADD
      | SQL_CA1_NEXT | SQL_CA1_ABSOLUTE | SQL_CA1_RELATIVE), infoVal)
      << "SQLGetInfo returned successfully";

  retcode = ::SQLGetInfo(hdbc, SQL_DYNAMIC_CURSOR_ATTRIBUTES2, &infoVal, 0,
      nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ((SQL_CA2_SIMULATE_TRY_UNIQUE | SQL_CA2_READ_ONLY_CONCURRENCY
      | SQL_CA2_SENSITIVITY_ADDITIONS | SQL_CA2_SENSITIVITY_DELETIONS
      | SQL_CA2_SENSITIVITY_UPDATES), infoVal)
      << "SQLGetInfo returned successfully";
  ...
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ(SQL_CA2_SIMULATE_TRY_UNIQUE | SQL_CA2_READ_ONLY_CONCURRENCY,
      infoVal) << "SQLGetInfo returned successfully";

  retcode = ::SQLGetInfo(hdbc, SQL_BATCH_SUPPORT, &infoVal, 0, nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ(SQL_BS_ROW_COUNT_EXPLICIT | SQL_BS_SELECT_PROC
      | SQL_BS_ROW_COUNT_PROC, infoVal) << "SQLGetInfo returned successfully";
  retcode = ::SQLGetInfo(hdbc, SQL_BATCH_ROW_COUNT, &infoVal, 0, nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ(SQL_BRC_EXPLICIT, (int)infoVal) << "SQLGetInfo returned successfully";

  retcode = ::SQLGetInfo(hdbc, SQL_PARAM_ARRAY_ROW_COUNTS, &infoVal, 0,
      nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ(SQL_PARC_BATCH, (int)infoVal) << "SQLGetInfo returned successfully";

  retcode = ::SQLGetInfo(hdbc, SQL_CURSOR_COMMIT_BEHAVIOR, &infoVal, 0,
      nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ(SQL_CB_CLOSE, (int)infoVal) << "SQLGetInfo returned successfully";

  retcode = ::SQLGetInfo(hdbc, SQL_CURSOR_ROLLBACK_BEHAVIOR, &infoVal, 0,
      nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ(SQL_CB_DELETE, (int)infoVal) << "SQLGetInfo returned successfully";

  retcode = ::SQLGetInfo(hdbc, SQL_GETDATA_EXTENSIONS, &infoVal, 0, nullptr);
  EXPECT_NE(SQL_ERROR, retcode) << "SQLGetInfo returned successfully";
  EXPECT_EQ(SQL_GD_ANY_COLUMN | SQL_GD_ANY_ORDER | SQL_GD_BLOCK
      | SQL_GD_BOUND, (int)infoVal) << "SQLGetInfo returned successfully";
